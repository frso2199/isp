...
?>
    ...
    <div class="">
        <div class="boxMain">
            <form method="post" action="https://www.srilakshminetworks.com/invoice_generate.php">
                <div style="padding-top: 8px;">
                    <div class="left">
                        <div class="leftContent">
                            <img src="./images/splogo.jpg" alt="logo" style="margin-top:9px;">
                            <p style="padding-top: 18px;"><b style="font-size: 19px;"><input
                                            value="<?php if (isset($_POST['fname'])) echo $_POST['fname']; else echo $customer_data['fname']; ?>"
                                            name="fname"> ,</b>
                                <br> <span
                                        style="letter-spacing: 1.5px;font-weight: 500;font-size: 14px;display: block;width:300px;word-wrap: break-word;"><textarea
                                            name="address" rows="2"
                                            cols="30"><?php if (isset($_POST['address'])) echo $_POST['address']; else echo $customer_data['address']; ?></textarea></span>
                                <span style="letter-spacing: 1.5px;position: relative;top: 3px;padding-bottom: 6px;font-weight: 500;font-size: 14px;"><input
                                            value="<?php if (isset($_POST['cityname'])) echo $_POST['cityname']; else echo $customer_data['cityname']; ?>"
                                            name="cityname"></span>
                            </p>
                            <ul class="leftul">
                                <li>Contact No <span>:</span></li>
                                <li style="padding-left: 11px;"><input
                                            value="<?php if (isset($_POST['mobile'])) echo $_POST['mobile']; else echo $mobile; ?>"
                                            name="mobile"></li>
                            </ul>
                            <ul class="leftul" style="padding-top: 3px;">
                                <li>User Id<span>:</span></li>
                                <li style="padding-left: 44px;"><input
                                            value="<?php if (isset($_POST['actid'])) echo $_POST['actid']; else echo $customer_data['actid']; ?>"
                                            name="actid">
                                </li>
                            </ul>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;"><input
                                            value="<?php if (isset($_POST['actiddata'])) echo $_POST['actiddata']; else echo $customer_data['actid']; ?>"
                                            name="actiddata"></td>
                            </tr>
                            <tr>
                                <td>Invoice No</td>
                                <td style="text-align: right;"><input
                                            value="<?php if (isset($_POST['ino'])) echo $_POST['ino']; else echo '17-18/' . $request_result['id']; ?>"
                                            name="ino">
                                </td>
                            </tr>
                            <tr>
                                <td>Pay By Date</td>
                                <td style="text-align: right;"><input
                                            value="<?php if (isset($_POST['createdat'])) echo $_POST['createdat']; else echo $request_result['created_at']; ?>"
                                            name="createdat"></td>
                            </tr>
                            <tr>
                                <td>Invoice Period</td>
                                <td style="text-align: right;"><input
                                            value="<?php if (isset($_POST['invoiceperiod'])) echo $_POST['invoiceperiod']; else echo date_format(date_create($subscriptions['startdt']), "Y-m-d") . ' To ' . date_format(date_create($subscriptions['expirydt']), "Y-m-d"); ?>"
                                            name="invoiceperiod"></td>
                            </tr>
                            <tr>
                                <td>GST%</td>
                                <td style="text-align: right;">
                                    <input value="<?php if (isset($_POST['gstdata'])) echo $_POST['gstdata']; ?>"
                                           name="gstdata"></td>
                            </tr>
                            </tbody>
                        </table>

                        <div class="leftul" style="padding-top: 40px;">
                            <input value="<?= $order_id ?>" name="id_trans" type="hidden">
                            <button value="Save" name="savesend">Save Generate</button>
                        </div>
                    </div>
                </div>
            </form>
...
//$customer_data = $customer_data[0];
            ...
            <div style="padding-top: 8px;">
                <div class="left">
                    <div class="leftContent">
                        ...
                        <p style="padding-top: 18px;"><b style="font-size: 19px;">' . $_POST['fname'] . ',</b>
                            <br> <span style="letter-spacing: 1.5px;font-weight: 500;font-size: 10px;display: block;width:350px;word-wrap: break-word;">' . $_POST['address'] . '</span>
                            <span style="letter-spacing: 1.5px;position: relative;top: 3px;padding-bottom: 6px;font-weight: 500;font-size: 12px;">' . $_POST['cityname'] . '</span></p>
                        <ul class="leftul">
                            <li>Contact No <span>:</span></li>
                            <li style="padding-left: 11px;">' . $_POST['mobile'] . '</li>
                        </ul>
                        <ul class="leftul" style="padding-top: 3px;">
                            <li>User Id<span>:</span></li>
                            <li style="padding-left: 44px;">' . $_POST['actid'] . '</li>
                        </ul>
                    </div>
                </div>
                <div class="rightInvoice">
                    ...
                    <table >
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;font-size: 12px;">' . $_POST['actiddata'] . '</td>
                        </tr>
                        <tr>
                            <td style="font-size: 12px;">Invoice No :</td>
                            <td style="text-align: right;font-size: 12px;">' . $_POST['ino'] . '</td>
                        </tr>
                        <tr>
                            <td style="font-size: 12px;">Pay By Date :</td>
                            <td style="text-align: right;font-size: 12px;">' . $_POST['createdat'] . '</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Invoice Period :</td>
                            <td style="text-align: right;">' . $_POST['invoiceperiod'] . '</td>
                        </tr>
                        <tr>
                         <td>GST%</td>
                                <td style="text-align: right;">' . $_POST['gstdata'] . '</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    $filename = dompdf($dd);
    //send_mail($message, "jaydipbhingradiya@gmail.com", $filename);
