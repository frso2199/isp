...
?>
    ...
    <div class="">
        <div class="boxMain">
            <form method="post" action="https://www.srilakshminetworks.com/staging/invoice_generate.php">
                <div style="padding-top: 8px;">
                    <div class="left">
                        <div class="leftContent">
                            <img src="./images/splogo.jpg" alt="logo" style="margin-top:9px;">
                            <p style="padding-top: 18px;"><b style="font-size: 19px;"><?php echo $customer_data['fname']; ?> ,</b>
                                <br> <span
                                        style="letter-spacing: 1.5px;font-weight: 500;font-size: 14px;display: block;width:300px;word-wrap: break-word;"><?php $customer_data['address']; ?></span>
                                <span style="letter-spacing: 1.5px;position: relative;top: 3px;padding-bottom: 6px;font-weight: 500;font-size: 14px;"><?php echo $customer_data['cityname']; ?></span>
                            </p>
                            <ul class="leftul">
                                <li>Contact No <span>:</span></li>
                                <li style="padding-left: 11px;"><?php echo $mobile; ?></li>
                            </ul>
                            <ul class="leftul" style="padding-top: 3px;">
                                <li>User Id<span>:</span></li>
                                <li style="padding-left: 44px;"><?php echo $customer_data['actid']; ?>
                                </li>
                            </ul>
                    ...
                    <div class="rightInvoice" style="width: 400px">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>Account Id</td>
                                <td style="text-align: right;"><?php echo $customer_data['actid']; ?></td>
                            </tr>
                            <tr>
                                <td>Invoice No</td>
                                <td style="text-align: right;"><?php echo '17-18/' . $request_result['id']; ?>
                                </td>
                            </tr>
                            <tr>
                                <td>Pay By Date</td>
                                <td style="text-align: right;"><?php  echo $request_result['created_at']; ?></td>
                            </tr>
                            <tr>
                                <td>Invoice Period</td>
                                <td style="text-align: right;"><?php  echo date_format(date_create($subscriptions['startdt']), "Y-m-d") . 'To' . date_format(date_create($subscriptions['expirydt']), "Y-m-d"); ?></td>
                            </tr>
                            <tr>
                                <td>GST%</td>
                                <td style="text-align: right;"><?php echo $_POST['gstdata']; ?></td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="leftul" style="padding-top: 40px;">
                            ...
                            <!--<button value="Save" name="savesend">Print</button>-->
                        </div>
                    </div>
                </div>
            </form>
